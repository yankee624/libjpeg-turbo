...
int main(void) {
  ...
  //     in_image_buffer[r * image_width * image_components + c * image_components + 0] = (r*5) % 255;
  //     in_image_buffer[r * image_width * image_components + c * image_components + 1] = (r*5) % 255;
  //     in_image_buffer[r * image_width * image_components + c * image_components + 2] = (r*5) % 255;
  //   }
  // }
